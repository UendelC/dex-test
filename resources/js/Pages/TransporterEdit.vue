...
const props = defineProps(['transporter']);
const cep = ref('');
...
function submit() {
    router.put(`/transporters/${props.transporter.id}`, props.transporter);
}
...
<template>
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Editar transportador {{ transporter.name }}</h2>
        </template>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            name="neighborhood"
                            id="neighborhood"
                            v-model="transporter.neighborhood"
                            class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            name="state_code"
                            id="state_code"
                            v-model="transporter.state_code"
                            class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
                    </div>
                    <div>
                        ...
                        <input
                            ...
                            name="credit_limit"
                            id="credit_limit"
                            v-model="transporter.credit_limit"
                            class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
                    </div>
                    <div>
                        ...
                        <input
                            ...
                            v-model="transporter.credit_analysis_date"
                            class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
                    </div>
                </div>
                <div class="mt-4">
